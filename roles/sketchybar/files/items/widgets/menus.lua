...
return function(sbar)
	...
	local menu_watcher_item = Item:new(sbar, "menu_watcher", {
	    drawing = false,
	    updates = false
	})
	local menu_watcher = menu_watcher_item:render()
	local space_menu_swap_item = Item:new(sbar, "space_menu_swap", {
	    drawing = false,
	    updates = true
	})
	local space_menu_swap = space_menu_swap_item:render()
